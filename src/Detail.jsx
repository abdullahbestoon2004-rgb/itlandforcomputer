      ...
      <main style={{ maxWidth:900, margin:'0 auto', padding:'22px 20px 80px' }}>
        ...
        <div style={{ background:'#fff', border:'2px solid #17130E', borderRadius:22, boxShadow:'6px 6px 0 #17130E', overflow:'hidden' }}>
          ...
          <div style={{ padding:'30px 30px 34px' }}>
            ...
            <h1 style={{ margin:'0 0 8px', fontSize:30, lineHeight:1.2, fontWeight:800 }}>{item.n}</h1>
            ...
            <div style={{ display:'flex', flexWrap:'wrap', gap:'14px 40px', padding:'20px 0', borderTop:'1.5px dashed #E9DFC9', borderBottom:'1.5px dashed #E9DFC9' }}>
              <div>
                ...
                <div dir="ltr" style={{ fontSize:38, fontWeight:800, fontFamily:"'Space Mono',ui-monospace,monospace", color:'var(--pri)', lineHeight:1 }}>{priceLabel(item, t)}</div>
              </div>
              {item.retail != null && (
                <div>
            ...
            {item.d && (
              <div style={{ marginTop:24 }}>
                ...
                <p style={{ margin:0, fontSize:15, lineHeight:1.65, color:'#2B2419', maxWidth:'60ch' }}>{item.d}</p>
              </div>
            )}
          </div>
        </div>
