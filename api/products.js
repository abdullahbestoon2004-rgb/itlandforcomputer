...
function findProductImage(item) {
  ...
  for (const file of LOCAL_IMAGES) {
    ...
    // Look for explicit model code token containing digits e.g. "c270", "m171", "c3200", "otn-5138hv", "4210"
    ...
    if (modelToken && textWords.has(modelToken)) {
      ...
      // Require ALL tokens of image filename to be present in item text
